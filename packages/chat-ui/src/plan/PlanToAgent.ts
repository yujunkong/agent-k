...
export class PlanToAgent {
  ...
  buildTransitionContext(
    ...
    const systemPrompt = [
      ...
      'For each step, read relevant files first, then make the necessary changes with write_file/edit_file in the **same** run.',
      'Never end with "Proceeding to write files…" or a re-stated plan — call write_file/edit_file instead.',
