/**
 * CTX-009 Mention extraction — ported from v2.1 `src/prefetch/MentionExtractor.ts`.
 * Parses @file: / @folder: / @symbol: / @codebase: (optional line ranges).
 */
...
export function extractMentions(text: string): Mention[] {
  ...
  // Reset sticky global regex between calls
