/**
 * ArtifactStore — ART-001: 스크린샷/데모/diff 카드 저장 (v2.1 C7-T16 동작 동등 이식)
 * ART-002 갤러리 UI는 chat-ui(React) — store + markdown export만 core 담당.
 */
...
export class ArtifactStore {
  ...
  /**
   * Export artifact gallery as markdown (ART-002 파생물)
   */
