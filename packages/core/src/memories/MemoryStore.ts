/**
 * MemoryStore — MEM-001/002: 영구 메모리 + SecretStorage port
 * (v2.1 C7-T14 동작 동등 이식)
 *
 * - SecretStorage port 연동으로 재시작 후에도 영구 유지 (host가 vscode.SecretStorage 어댑터 주입)
...
/** SecretStorage port — host injects vscode.SecretStorage adapter (MEM-002). */
