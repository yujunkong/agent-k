...
# repo root = parent of REWORK_TASKS/
SCRIPT_DIR = Path(__file__).resolve().parent
REPO_ROOT = SCRIPT_DIR.parent.parent
DONE_GLOB = "DONE_TASKS/**/*.json"
REPORT_PATH = REPO_ROOT / "REWORK_TASKS" / "reports" / "missing-files-audit.md"
...
def is_intentional_na(path: str) -> tuple[bool, str]:
    ...
    meta_prefixes = ("PRD", "TODO_TASKS/", "DONE_TASKS/", "REWORK_TASKS/")
...
def render_report(audits: list[TaskAudit]) -> str:
    ...
    lines = [
        ...
        "",
        f"> Generated: {now} · Script: `REWORK_TASKS/scripts/audit-missing-files.py`",
        "",
        "## Summary",
        "",
        f"| Metric | Count |",
