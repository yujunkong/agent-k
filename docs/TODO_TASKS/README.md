...
> **Source**: PRD Implementation Runbook + Phase PRDs (C0-C7) + 90 PRD Documents + [`docs/addon.md`](../addon.md)
> **Generated**: 2026-07-25 · **Updated**: 2026-07-27 (ADDON)
> **Total Phases**: 8 (C0-C7) + HARB + **ADDON** | **Task format**: `tasks/<PHASE>/<ID>.json` + master index  
> **Related**: 완료/rework JSON은 [`DONE_TASKS/`](../DONE_TASKS/README.md) · 감사 재작업은 [`REWORK_TASKS/`](../REWORK_TASKS/README.md) (**P0→P2**)  
> **다음 착수**: [`tasks/ADDON/`](./tasks/ADDON/) — addon.md에서 추린 필요/부족 갭 (18 tasks)
...
└── tasks/
    ├── ADDON/ # docs/addon.md 갭 (Test검증·timeout·Plan게이트·컨텍스트·UX) ← 신규
...
| v1.6 | 2026-07-27 | **ADDON** phase 18 tasks (`docs/addon.md` 필요/부족 갭) · MASTER/README 반영 |
...
- [ ] `MASTER_TASK_INDEX.md` 동기화: `python3 docs/REWORK_TASKS/scripts/sync-master-index.py --update-index`
