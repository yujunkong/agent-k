...
Usage:
  python3 docs/REWORK_TASKS/scripts/fix-done-files-paths.py           # dry-run summary
  python3 docs/REWORK_TASKS/scripts/fix-done-files-paths.py --apply   # patch DONE JSON
"""
