...
C0–C4가 `docs/DONE_TASKS/`로 이동되어 있으나:
...
4. `docs/TODO_TASKS/MASTER_TASK_INDEX.md` 동기화: `python3 docs/REWORK_TASKS/scripts/sync-master-index.py --update-index`
...
| From | To | When |
|------|-----|------|
| `TODO_TASKS/tasks/` | `docs/DONE_TASKS/` | AC + 증빙 + 인덱스 ✅/🔄 반영 |
| `docs/DONE_TASKS/` | `REWORK_TASKS/tasks/` | 감사 FAIL, `status: rework` |
...
- [`docs/DONE_TASKS/`](../DONE_TASKS/README.md) — 완료 JSON 아카이브 (신뢰도 주의)
- [`docs/TODO_TASKS/`](../TODO_TASKS/README.md) — C5–HARB pending + [`MASTER_TASK_INDEX.md`](../TODO_TASKS/MASTER_TASK_INDEX.md)
