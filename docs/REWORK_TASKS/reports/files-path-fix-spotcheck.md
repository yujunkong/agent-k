...
> Re-audit: `python3 docs/REWORK_TASKS/scripts/audit-missing-files.py --write-report` → **30 tasks**, **11 class A**, **24 class B** (B = missing tests/unimplemented; out of scope for path remap)
...
```bash
python3 docs/REWORK_TASKS/scripts/fix-done-files-paths.py --apply
