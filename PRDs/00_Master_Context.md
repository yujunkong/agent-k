...
> **원본 설계 문서**: `Extension_high_impact.md`  
...
- **원본 설계**: `Extension_high_impact.md` (이 저장소 루트)
- **PRD 인덱스**: `PRDs/README.md`
- **추적성 매트릭스**: `PRDs/PRD-Traceability-Matrix.md`
- **의존성 그래프**: `PRDs/PRD-Dependency-Graph.md`
- **구현 런북**: `PRDs/PRD-Implementation-Runbook.md`
...
> **SSOT (설계 진실)**: 저장소 루트 `Extension_high_impact.md`  
