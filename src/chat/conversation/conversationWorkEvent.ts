 ...
 *
 * Contract types live in @agent-k/shared (Phase 0). Mappers that need host
 * timeline helpers remain here until those edges are cut.
 */
...
import type {
  ...
  ConversationWorkType,
  HostWorkPayload
} from '../../../packages/shared/src/workEvent';
import { WORK_TYPE_LABEL } from '../../../packages/shared/src/workEvent';
...
export { WORK_TYPE_LABEL } from '../../../packages/shared/src/workEvent';
